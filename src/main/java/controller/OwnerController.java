...
public class OwnerController {
    ...
    public boolean insertStoreRegist(StoreRegistDTO dto) {
        return 0 != ownerService.insertStoreRegist(dto.getName(), dto.getComment(), dto.getPhone(), dto.getAddress(), dto.getUser_pk());
    }
